...
impl Node {
    ...
    pub fn make_transaction_and_mine(&mut self, from: &'static str, to: &'static str, amount: i32) {
...
impl Receive<AddTransactionAndMine> for Node {
    ...
    fn receive(&mut self, _ctx: &Context<Self::Msg>, msg: AddTransactionAndMine, _sender: Sender) {
